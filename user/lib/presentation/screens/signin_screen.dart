...
class SigninScreen extends StatelessWidget {
    ...
    return BlocListener<AuthCubitCubit, AuthCubitState>(
      listener: (context, state) {
        if(state is AuthLoading){
          ...
          CostumWidget.showCustomSnackbar(context: context, message: 'Sign in succesfull');
  ...
  _signIn(GlobalKey<FormState>formKey, BuildContext context){
    if(formKey.currentState!.validate()){
      try{
      UserModel user=UserModel(userName: '', phoneNumber: '', email: emailController.text
    , imagePath: '');

    context.read<AuthCubitCubit>().signIn(user, passwordConttoller.text);
