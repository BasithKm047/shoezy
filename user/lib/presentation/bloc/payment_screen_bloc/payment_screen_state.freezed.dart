...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is PaymentScreenState);
}
...
/// @nodoc
class $PaymentScreenStateCopyWith<$Res>  {
$PaymentScreenStateCopyWith(PaymentScreenState _, $Res Function(PaymentScreenState) __);
}


/// Adds pattern-matching-related methods to [PaymentScreenState].
extension PaymentScreenStatePatterns on PaymentScreenState {
...
class _Initial implements PaymentScreenState {
  const _Initial();
...
@override
String toString() {
  return 'PaymentScreenState.initial()';
}
...
class _Loading implements PaymentScreenState {
  const _Loading();
...
@override
String toString() {
  return 'PaymentScreenState.loading()';
}
...
/// @nodoc
abstract mixin class _$LoadedCopyWith<$Res> implements $PaymentScreenStateCopyWith<$Res> {
...
class _Error implements PaymentScreenState {
...
@override
String toString() {
  return 'PaymentScreenState.error(message: $message)';
}
...
/// @nodoc
abstract mixin class _$ErrorCopyWith<$Res> implements $PaymentScreenStateCopyWith<$Res> {
