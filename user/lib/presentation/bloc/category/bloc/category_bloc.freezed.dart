...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( _LoadCategories value)?  loadCategories,TResult Function( _SearchCategories value)?  searchCategories,required TResult orElse(),}){
final _that = this;
switch (_that) {
case _LoadCategories() when loadCategories != null:
return loadCategories(_that);case _SearchCategories() when searchCategories != null:
return searchCategories(_that);case _:
  return orElse();
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( _LoadCategories value)  loadCategories,required TResult Function( _SearchCategories value)  searchCategories,}){
final _that = this;
switch (_that) {
case _LoadCategories():
return loadCategories(_that);case _SearchCategories():
return searchCategories(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( _LoadCategories value)?  loadCategories,TResult? Function( _SearchCategories value)?  searchCategories,}){
final _that = this;
switch (_that) {
case _LoadCategories() when loadCategories != null:
return loadCategories(_that);case _SearchCategories() when searchCategories != null:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  loadCategories,TResult Function( String query)?  searchCategories,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _LoadCategories() when loadCategories != null:
return loadCategories();case _SearchCategories() when searchCategories != null:
return searchCategories(_that.query);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  loadCategories,required TResult Function( String query)  searchCategories,}) {final _that = this;
switch (_that) {
case _LoadCategories():
return loadCategories();case _SearchCategories():
return searchCategories(_that.query);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  loadCategories,TResult? Function( String query)?  searchCategories,}) {final _that = this;
switch (_that) {
case _LoadCategories() when loadCategories != null:
return loadCategories();case _SearchCategories() when searchCategories != null:
return searchCategories(_that.query);case _:
...
class _SearchCategories implements CategoryEvent {
  const _SearchCategories(this.query);
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _SearchCategories&&(identical(other.query, query) || other.query == query));
}
...
/// @nodoc
abstract mixin class _$SearchCategoriesCopyWith<$Res> implements $CategoryEventCopyWith<$Res> {
