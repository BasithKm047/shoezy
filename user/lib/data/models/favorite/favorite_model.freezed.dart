...
mixin _$FavoriteModel {
 ...
 String? get userId; ProductModel get product; bool? get isFavorite; DateTime? get createdAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,userId,product,isFavorite,createdAt);

@override
String toString() {
  return 'FavoriteModel(userId: $userId, product: $product, isFavorite: $isFavorite, createdAt: $createdAt)';
}
...
@useResult
$Res call({
 String? userId, ProductModel product, bool? isFavorite, DateTime? createdAt
});
...
/// Create a copy of FavoriteModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? userId = freezed,Object? product = null,Object? isFavorite = freezed,Object? createdAt = freezed,}) {
  return _then(_self.copyWith(
userId: freezed == userId ? _self.userId : userId // ignore: cast_nullable_to_non_nullable
as String?,product: null == product ? _self.product : product // ignore: cast_nullable_to_non_nullable
as ProductModel,isFavorite: freezed == isFavorite ? _self.isFavorite : isFavorite // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String? userId,  ProductModel product,  bool? isFavorite,  DateTime? createdAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _FavoriteModel() when $default != null:
return $default(_that.userId,_that.product,_that.isFavorite,_that.createdAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String? userId,  ProductModel product,  bool? isFavorite,  DateTime? createdAt)  $default,) {final _that = this;
switch (_that) {
case _FavoriteModel():
return $default(_that.userId,_that.product,_that.isFavorite,_that.createdAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String? userId,  ProductModel product,  bool? isFavorite,  DateTime? createdAt)?  $default,) {final _that = this;
switch (_that) {
case _FavoriteModel() when $default != null:
return $default(_that.userId,_that.product,_that.isFavorite,_that.createdAt);case _:
  return null;
...
class _FavoriteModel implements FavoriteModel {
   _FavoriteModel({this.userId, required this.product, this.isFavorite, this.createdAt});
...
/// Create a copy of FavoriteModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? userId = freezed,Object? product = null,Object? isFavorite = freezed,Object? createdAt = freezed,}) {
