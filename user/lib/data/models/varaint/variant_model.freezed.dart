...
mixin _$Variantsmodel {
 ...
 String? get id; String get color; List<String> get images;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Variantsmodel&&(identical(other.id, id) || other.id == id)&&(identical(other.color, color) || other.color == color)&&const DeepCollectionEquality().equals(other.images, images));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,color,const DeepCollectionEquality().hash(images));
...
@useResult
$Res call({
 String? id, String color, List<String> images
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String? id,  String color,  List<String> images)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Variantsmodel() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String? id,  String color,  List<String> images)  $default,) {final _that = this;
switch (_that) {
case _Variantsmodel():
return $default(_that.id,_that.color,_that.images);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String? id,  String color,  List<String> images)?  $default,) {final _that = this;
switch (_that) {
case _Variantsmodel() when $default != null:
return $default(_that.id,_that.color,_that.images);case _:
  return null;
...
class _Variantsmodel implements Variantsmodel {
  const _Variantsmodel({this.id, required this.color, required final  List<String> images}): _images = images;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Variantsmodel&&(identical(other.id, id) || other.id == id)&&(identical(other.color, color) || other.color == color)&&const DeepCollectionEquality().equals(other._images, _images));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,color,const DeepCollectionEquality().hash(_images));
