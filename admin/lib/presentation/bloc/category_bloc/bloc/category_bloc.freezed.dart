...
class ImageRemoved implements CategoryEvent {
  const ImageRemoved({required this.removedImages});
  

 final  Uint8List removedImages;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ImageRemoved&&const DeepCollectionEquality().equals(other.removedImages, removedImages));
}


@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(removedImages));

@override
String toString() {
  return 'CategoryEvent.imageRemoved(removedImages: $removedImages)';
}
...
removedImages: null == removedImages ? _self.removedImages : removedImages // ignore: cast_nullable_to_non_nullable
as Uint8List,
  ));
}
