...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( ProductModel products)?  addProduct,TResult Function()?  removeProduct,TResult Function()?  updateProduct,TResult Function( List<Uint8List> images)?  uploadImage,TResult Function( Uint8List removedImage)?  removeImage,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AddProduct() when addProduct != null:
...
return removeImage(_that.removedImage);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( ProductModel products)  addProduct,required TResult Function()  removeProduct,required TResult Function()  updateProduct,required TResult Function( List<Uint8List> images)  uploadImage,required TResult Function( Uint8List removedImage)  removeImage,}) {final _that = this;
switch (_that) {
case _AddProduct():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function( ProductModel products)?  addProduct,TResult? Function()?  removeProduct,TResult? Function()?  updateProduct,TResult? Function( List<Uint8List> images)?  uploadImage,TResult? Function( Uint8List removedImage)?  removeImage,}) {final _that = this;
switch (_that) {
case _AddProduct() when addProduct != null:
return addProduct(_that.products);case _RemoveProduct() when removeProduct != null:
return removeProduct();case _UpdateProduct() when updateProduct != null:
...
class _RemoveImage implements ProductEvent {
  const _RemoveImage(this.removedImage);
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _RemoveImage&&const DeepCollectionEquality().equals(other.removedImage, removedImage));
}
...
@override
String toString() {
  return 'ProductEvent.removeImage(removedImage: $removedImage)';
}
