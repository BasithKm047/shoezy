...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( _ImageUploadedEvent value)?  imageUpload,TResult Function( _ImageRemoved value)?  imageRemoved,TResult Function( _AddVaraints value)?  addVariants,TResult Function( _Getvariants value)?  getVariants,TResult Function( _ResetImage value)?  resetImgae,TResult Function( _RemoveVariants value)?  removeVariants,TResult Function( _UpdateVariants value)?  updateVariants,TResult Function( _SearchVariants value)?  searchVariants,TResult Function( _DeleteVariants value)?  deleteVariants,TResult Function( _ShowFields value)?  showFields,TResult Function( _HideFields value)?  hideFields,TResult Function( _ToggleFields value)?  toggleFields,required TResult orElse(),}){
final _that = this;
switch (_that) {
...
return toggleFields(_that);case _:
  return orElse();
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( _ImageUploadedEvent value)  imageUpload,required TResult Function( _ImageRemoved value)  imageRemoved,required TResult Function( _AddVaraints value)  addVariants,required TResult Function( _Getvariants value)  getVariants,required TResult Function( _ResetImage value)  resetImgae,required TResult Function( _RemoveVariants value)  removeVariants,required TResult Function( _UpdateVariants value)  updateVariants,required TResult Function( _SearchVariants value)  searchVariants,required TResult Function( _DeleteVariants value)  deleteVariants,required TResult Function( _ShowFields value)  showFields,required TResult Function( _HideFields value)  hideFields,required TResult Function( _ToggleFields value)  toggleFields,}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( _ImageUploadedEvent value)?  imageUpload,TResult? Function( _ImageRemoved value)?  imageRemoved,TResult? Function( _AddVaraints value)?  addVariants,TResult? Function( _Getvariants value)?  getVariants,TResult? Function( _ResetImage value)?  resetImgae,TResult? Function( _RemoveVariants value)?  removeVariants,TResult? Function( _UpdateVariants value)?  updateVariants,TResult? Function( _SearchVariants value)?  searchVariants,TResult? Function( _DeleteVariants value)?  deleteVariants,TResult? Function( _ShowFields value)?  showFields,TResult? Function( _HideFields value)?  hideFields,TResult? Function( _ToggleFields value)?  toggleFields,}){
final _that = this;
switch (_that) {
case _ImageUploadedEvent() when imageUpload != null:
return imageUpload(_that);case _ImageRemoved() when imageRemoved != null:
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( _Initail value)?  inintial,TResult Function( _Loading value)?  loading,TResult Function( _Success value)?  success,TResult Function( _ImageAddedState value)?  imageAddedState,TResult Function( _Failure value)?  failure,TResult Function( _ImageRemovedState value)?  imageRemovedState,TResult Function( _VariantsLoaded value)?  variantsLoaded,TResult Function( _VariantAdded value)?  variantAdded,TResult Function( _VariantRemoved value)?  variantRemoved,TResult Function( _VariantUpdated value)?  variantUpdated,TResult Function( _VariantSearched value)?  variantSearched,TResult Function( _ShowFieldsState value)?  showFieldsState,TResult Function( _HideFieldsState value)?  hideFieldsState,required TResult orElse(),}){
final _that = this;
switch (_that) {
...
return hideFieldsState(_that);case _:
  return orElse();
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( _Initail value)?  inintial,TResult? Function( _Loading value)?  loading,TResult? Function( _Success value)?  success,TResult? Function( _ImageAddedState value)?  imageAddedState,TResult? Function( _Failure value)?  failure,TResult? Function( _ImageRemovedState value)?  imageRemovedState,TResult? Function( _VariantsLoaded value)?  variantsLoaded,TResult? Function( _VariantAdded value)?  variantAdded,TResult? Function( _VariantRemoved value)?  variantRemoved,TResult? Function( _VariantUpdated value)?  variantUpdated,TResult? Function( _VariantSearched value)?  variantSearched,TResult? Function( _ShowFieldsState value)?  showFieldsState,TResult? Function( _HideFieldsState value)?  hideFieldsState,}){
final _that = this;
switch (_that) {
case _Initail() when inintial != null:
return inintial(_that);case _Loading() when loading != null:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  inintial,TResult Function()?  loading,TResult Function()?  success,TResult Function( List<Uint8List> images)?  imageAddedState,TResult Function( String error)?  failure,TResult Function( List<Uint8List> image)?  imageRemovedState,TResult Function( List<Variantsmodel> variants)?  variantsLoaded,TResult Function()?  variantAdded,TResult Function()?  variantRemoved,TResult Function()?  variantUpdated,TResult Function( List<Variantsmodel> variants)?  variantSearched,TResult Function()?  showFieldsState,TResult Function()?  hideFieldsState,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Initail() when inintial != null:
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  inintial,TResult? Function()?  loading,TResult? Function()?  success,TResult? Function( List<Uint8List> images)?  imageAddedState,TResult? Function( String error)?  failure,TResult? Function( List<Uint8List> image)?  imageRemovedState,TResult? Function( List<Variantsmodel> variants)?  variantsLoaded,TResult? Function()?  variantAdded,TResult? Function()?  variantRemoved,TResult? Function()?  variantUpdated,TResult? Function( List<Variantsmodel> variants)?  variantSearched,TResult? Function()?  showFieldsState,TResult? Function()?  hideFieldsState,}) {final _that = this;
switch (_that) {
case _Initail() when inintial != null:
return inintial();case _Loading() when loading != null:
return loading();case _Success() when success != null:
